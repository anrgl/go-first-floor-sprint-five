...
func (w Walking) Calories() float64 {
	return ((CaloriesWeightMultiplier*float64(w.Weight) + math.Pow(w.meanSpeed(), 2)/w.Height) * CaloriesSpeedHeightMultiplier * float64(w.Weight)) * w.Duration.Hours() * MinInHours
}
